...
where
	Self: Add<Change<&'a B>>
{
	type Output = <Self as Add<Change<&'a B>>>::Output;
...
where
	Self: Sub<Change<&'a B>>
{
	type Output = <Self as Sub<Change<&'a B>>>::Output;
...
where
	Self: Mul<Change<&'a B>>
{
	type Output = <Self as Mul<Change<&'a B>>>::Output;
...
where
	Self: Div<Change<&'a B>>
{
	type Output = <Self as Div<Change<&'a B>>>::Output;
